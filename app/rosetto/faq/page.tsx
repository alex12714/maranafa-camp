...
const faq = [
  ...
  },
  {
    ...
    a: "Партнёров подбираем и проверяем мы, а услугу оказывает и профессиональную ответственность за неё несёт сам специалист или его организация. Если специалист не подошёл — скажите координатору: это влияет на то, останется ли он в пуле.",
  },
  {
