...
export default function CampPastorRolePage() {
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Пастор лагеря</h1>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          ...
          <p className="mb-4">Быть духовным ментором в лагере.</p>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <ul className="space-y-2">
            <li className="flex items-start">
              ...
              <span>Утренняя молитва с персоналом и наставниками</span>
            </li>
            <li className="flex items-start">
              <span className="text-[#FFD700] mr-2">•</span>
              <span>Короткая проповедь на утреннем собрании</span>
            </li>
            <li className="flex items-start">
              <span className="text-[#FFD700] mr-2">•</span>
              <span>Душе-попечительство для наставников и персонала</span>
            </li>
            <li className="flex items-start">
              <span className="text-[#FFD700] mr-2">•</span>
              <span>Участие в планировании вечернего собрания</span>
            </li>
            <li className="flex items-start">
              <span className="text-[#FFD700] mr-2">•</span>
              <span>Проповедь на вечернем собрании</span>
            </li>
            <li className="flex items-start">
              <span className="text-[#FFD700] mr-2">•</span>
              <span>Духовно-попечительская работа с детьми</span>
            </li>
            <li className="flex items-start">
              <span className="text-[#FFD700] mr-2">•</span>
              <span>Индивидуальные консультации для воспитанников и сотрудников</span>
            </li>
            <li className="flex items-start">
              <span className="text-[#FFD700] mr-2">•</span>
              <span>Помощь в решении конфликтных ситуаций с духовной точки зрения</span>
            </li>
          </ul>
        </CardContent>
      </Card>
